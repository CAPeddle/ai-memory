...
- 2026-06-05 QP review follow-up: ST-046 was moved from Refined back to Backlog while blocked by ST-055. This avoids a `/continue` lifecycle hazard where Ready Refined stories may be auto-picked even when `Blocked by:` names another story. Restore ST-046 to Refined only after ST-055 is Done and this blocker is cleared.
