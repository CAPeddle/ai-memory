...
| 7 | Board freshness: stories merged to main have board status reflecting Done (not stuck in Backlog/In Progress/Review) | `git log origin/main --oneline --since="7 days ago" | grep "ST-"` and cross-check against board |
